...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        String updated = Utils.readContentsAsString(story) + args[1] + "\n";
        Utils.writeContents(story, updated);
    ...
    public static void makeDog(String[] args) {
        ...
        dog.saveDog();
        Dog dogSaved = Dog.fromFile(args[1]);
        System.out.println(dogSaved.toString());
    }
